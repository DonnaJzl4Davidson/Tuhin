...
def Herry():
    ...
    if Herryx =='5':
        exit()
    if Herryx =='3':
        os.system('xdg-open https://github.com/TUHIN AHMED?tab=projects ')
    if Herryx =='4':
        os.system('xdg-open https://www.facebook.com/TUHIN.VAI.NASA.HACKER.XODE.NA');Herry()
    if Herryx =='2':
        bangla()
    else:
